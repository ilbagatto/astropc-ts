...
describe('Positions', () => {
  ...
  const cases = [
    ...
    {
      id: PlanetId.Venus,
      pos: { lambda: 264.157, beta: 1.42582, delta: 1.229 },
    },
    {
      id: PlanetId.Mars,
      pos: { lambda: 214.982, beta: 1.67762, delta: 1.414 },
    },
    {
      id: PlanetId.Jupiter,
      pos: { lambda: 270.3, beta: 0.29758, delta: 6.11 },
    },
    {
      id: PlanetId.Saturn,
      pos: { lambda: 225.379, beta: 2.336, delta: 10.049 },
    },
    {
      id: PlanetId.Uranus,
      pos: { lambda: 252.174, beta: 0.052, delta: 19.633 },
    },
    {
      id: PlanetId.Neptune,
    ...
    {
      id: PlanetId.Pluto,
      pos: { lambda: 212.08, beta: 16.882, delta: 29.861 },
    },
  ];
...
describe('Apparent position', () => {
  ...
  for (const planetId of AllPlanets) {
    ...
    test(`${pla.name}: apparent vs Geometric longitude`, () => expect(dl).toBeGreaterThan(0));
    test(`${pla.name}: apparent vs Geometric latitude`, () => expect(db).toBeGreaterThan(0));
  }
});
